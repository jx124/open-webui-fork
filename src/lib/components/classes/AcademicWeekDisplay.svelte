<script lang="ts">
	...
	onMount(() => {
        ...
        weeks = weeks;
        console.log("weeks", weeks, weekProfilesMap);
	});
</script>

{#if noDeadlineProfiles}
	<div class="flex flex-col mb-10 text-black dark:text-white font-semibold border dark:border-gray-600 rounded-md outline-none overflow-hidden">
