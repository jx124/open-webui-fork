<script lang="ts">
    ...
    export let copyToClipboardWithToast: Function;
		...
		<div class="w-full overflow-hidden pl-1">
            ...
            >
                <div class="flex line-clamp-1">
                    <div>
                        <span class="text-lg font-medium text-sky-600 dark:text-sky-400">Chat Evaluation</span>
                ...
                {#if showEvaluation}
                    <ChevronUp className="self-center mr-2 size-5" strokeWidth={'2'} />
                {:else}
                    <ChevronDown className="self-center mr-2 size-5" strokeWidth={'2'} />
                {/if}
            </button>
                    ...
                    <div>
                        ...
                        <div class="w-full">
                            ...
                            {#if message.done || siblings.length > 1}
                                ...
                                <button
                                    class="flex self-center p-1 hover:bg-black/5 dark:hover:bg-white/5 dark:hover:text-white hover:text-black rounded-md transition"
                                    on:click={() => {
                                        copyToClipboardWithToast(message.content)
                                    }}
                                >
                                    <DocumentDuplicate className="self-center size-4" strokeWidth={'2'} />
