"""Peewee migrations -- 026_add_class_default_model_prompt.py.
...
def rollback(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    migrator.remove_fields("class", "default_model_id")
    migrator.remove_fields("class", "default_prompt_command")
